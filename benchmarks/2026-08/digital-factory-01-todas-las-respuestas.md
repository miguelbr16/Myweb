...
| Gemini 3.7 Flash | Gemini | Incluida |
| Composer 2.5 | Cursor | Incluida |

Orden de secciones: Grok → OpenCode → ChatGPT Go → Gemini → Composer.

Los archivos individuales siguen en esta carpeta por si hace falta citar uno solo. Esta es la fuente conjunta.

---

## Índice de lectura (no es evaluación)

Mapa de lo que **cada respuesta declara**. No puntúa calidad. No elige ganador.

| Campo | Grok 4.6 | OpenCode | ChatGPT Go | Gemini 3.7 Flash | Composer 2.5 |
|---|---|---|---|---|---|
| Diagnóstico | Secuencia: fábrica sin clientes | Secuencia: 0 conversaciones de venta | Secuencia: validación + sobreingeniería + deuda artesanal | Solución para un cliente que aún no existe; cuello de botella = adquisición | Oferta productizada + pipeline, no SiteSpec/RAG/agentes |
| Qué vender | Sistema de captación dental, 1 sede | “Sistema de Captación de Pacientes” (landing + respuesta <1 min + aviso + panel) | Landing/web de conversión dental (Dental Conversion Website) | “Sistema de Captación de Pacientes” (landing + form calificación + WA/email recepción) | Landing + web de conversión dental (1 servicio, 1 vertical) |
| ICP | Clínica privada España, 1 sede | 1–3 sedes, dueño, ya invierte en captación | Clínica privada con oferta relevante y web mejorable | 1–3 sedes; doctor propietario/gerente; implantes/ortodoncia/estética | 1–3 centros, web existente mediocre; no sin web; no cadenas |
| Promesa | Sistema medible 14+14 días; **no** N pacientes | Respuesta <1 min; landing 14 días; precio cerrado | Convertir tráfico existente; **no** X pacientes | Duplicar conversión móvil en <10 días sin cambiar dominio principal | Más citas desde la web en 14 días, sin depender solo de ads |
| Precio | **[HYPOTHESIS]** 2.500–4.500 € + 350–700 €/mes después; no cotizar en firme | **[HYPOTHESIS]** 1.500 € lista / 750 € fundador (5 primeros); retainer 200–400 €/mes | Sin cifra; experimento 2–3 niveles; no “precio de mercado” | **[HYPOTHESIS]** 950–1.500 € setup; presentar 1.200 €; retainer 150–250 €/mes | **[HYPOTHESIS]** 1.800–2.800 €; presentar 2.400 €; retainer 250–450 €/mes |
| Tope de fábrica (30d) | ≤8 h/semana | ≤5 días de build en el mes | Factory v0.1; resto espera repetición | Semana 1 = boilerplate + n8n; outbound desde semana 2 | Máx. 12 h/semana infra; mín. 18 h/semana ventas; fábrica 20 % |
| SiteSpec | BUILD NOW plantilla ≤25 campos | AFTER CLIENT 3 (completo); intake Tally ahora | BUILD NOW v0.1 | BUILD NOW Markdown | BUILD NOW v0.1 YAML |
| Componentes | Starter páginas v1, no 30 | 1 template; biblioteca formal AFTER CLIENT 3 | 1 template; 30 AFTER CLIENT 1 | Boilerplate 5 secciones; extra AFTER CLIENT 1 | BUILD NOW 8–10; 30 DO NOT BUILD |
| Design system | AFTER CLIENT 3 | AFTER CLIENT 3 | BUILD NOW mínimo | AFTER CLIENT 3 (completo) | AFTER CLIENT 1 (tokens ahora; Figma no) |
| Supabase | NO ahora | 1 tabla `leads` ahora (o Sheet) | AFTER CLIENT 1 | Sheets o Supabase vía n8n | NO propia; solo si OS lo exige tras cliente 3 |
| n8n | AFTER CLIENT 1 | 1 flujo ahora | AFTER CLIENT 1 | BUILD NOW (1 workflow forms→email/WA) | AFTER CLIENT 3 |
| Frontend | Astro o Next, uno | Astro + Tailwind; freeze 90 días | Stack moderno sin complejidad extra | Next.js App Router + Tailwind | Astro + Tailwind + React islands |
| Orquestación | **D** + fundador; Gemini→ChatGPT→Grok→Composer | **D** + fundador | **D** modificada: consejo paralelo Gemini/ChatGPT/Grok → Composer; fundador | **D**; Gemini intake → Composer código; contradicciones = menor complejidad | **D**; Gemini brief → Grok critique → humano → Composer; nadie es director |
| Mañana | Maps + 8 contactos antes de mediodía; 0 OS | 10 auditorías vídeo; 0 código hasta conversación agendada | Oferta + landing + demo + outreach (día largo de build comercial) | Repo base 5 secciones + listado 20 clínicas | 1-pager + landing + 5 outreach antes de mediodía |
