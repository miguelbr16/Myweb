...
**Estado:** 4/5 respuestas incluidas. Sin ranking ni ganador. El texto de cada modelo se copia tal cual.  
...
Orden de secciones: Grok → OpenCode → ChatGPT Go → Gemini → Composer (hueco).

Los archivos individuales siguen en esta carpeta (`grok-4.6-…`, `opencode-…`, `chatgpt-go-…`, `gemini-3.7-flash-…`) por si hace falta citar uno solo. Esta es la fuente conjunta.
...
| Campo | Grok 4.6 | OpenCode | ChatGPT Go | Gemini 3.7 Flash |
|---|---|---|---|---|
| Diagnóstico | Secuencia: fábrica sin clientes | Secuencia: 0 conversaciones de venta | Secuencia: validación + sobreingeniería + deuda artesanal | Solución para un cliente que aún no existe; cuello de botella = adquisición |
| Qué vender | Sistema de captación dental, 1 sede | “Sistema de Captación de Pacientes” (landing + respuesta <1 min + aviso + panel) | Landing/web de conversión dental (Dental Conversion Website) | “Sistema de Captación de Pacientes” (landing + form calificación + WA/email recepción) |
| ICP | Clínica privada España, 1 sede | 1–3 sedes, dueño, ya invierte en captación | Clínica privada con oferta relevante y web mejorable | 1–3 sedes; doctor propietario/gerente; implantes/ortodoncia/estética |
| Promesa | Sistema medible 14+14 días; **no** N pacientes | Respuesta <1 min; landing 14 días; precio cerrado | Convertir tráfico existente; **no** X pacientes | Duplicar conversión móvil en <10 días sin cambiar dominio principal |
| Precio | **[HYPOTHESIS]** 2.500–4.500 € + 350–700 €/mes después; no cotizar en firme | **[HYPOTHESIS]** 1.500 € lista / 750 € fundador (5 primeros); retainer 200–400 €/mes | Sin cifra; experimento 2–3 niveles; no “precio de mercado” | **[HYPOTHESIS]** 950–1.500 € setup; presentar 1.200 €; retainer 150–250 €/mes |
| Tope de fábrica (30d) | ≤8 h/semana | ≤5 días de build en el mes | Factory v0.1; resto espera repetición | Semana 1 = boilerplate + n8n; outbound desde semana 2 |
| SiteSpec | BUILD NOW plantilla ≤25 campos | AFTER CLIENT 3 (completo); intake Tally ahora | BUILD NOW v0.1 | BUILD NOW Markdown |
| Design system | AFTER CLIENT 3 | AFTER CLIENT 3 | BUILD NOW mínimo | AFTER CLIENT 3 (completo) |
| Supabase | NO ahora | 1 tabla `leads` ahora (o Sheet) | AFTER CLIENT 1 | Sheets o Supabase vía n8n |
| n8n | AFTER CLIENT 1 | 1 flujo ahora | AFTER CLIENT 1 | BUILD NOW (1 workflow forms→email/WA) |
| Frontend | Astro o Next, uno | Astro + Tailwind; freeze 90 días | Stack moderno sin complejidad extra | Next.js App Router + Tailwind |
| Orquestación | **D** + fundador; Gemini→ChatGPT→Grok→Composer | **D** + fundador | **D** modificada: consejo paralelo Gemini/ChatGPT/Grok → Composer; fundador | **D**; Gemini intake → Composer código; contradicciones = menor complejidad |
| Mañana | Maps + 8 contactos antes de mediodía; 0 OS | 10 auditorías vídeo; 0 código hasta conversación agendada | Oferta + landing + demo + outreach (día largo de build comercial) | Repo base 5 secciones + listado 20 clínicas |
